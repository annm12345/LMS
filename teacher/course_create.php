...
if(isset($_SESSION['TEACHER_LOGIN'])){
    ...
    if(isset($_POST['save'])){
        ...
        $feed=get_safe_value($con,$_POST['feed']);
        date_default_timezone_set('Asia/Yangon');
        $added_on=date('Y-m-d h:i:s');
      
        
         mysqli_query($con,"INSERT INTO `course`(`email`, `name`, `image`, `duration`,`level`, `category`,`feed`, `added_on`) VALUES ('$email','$name','$image','$duration','$level','$category','$feed','$added_on')");
            ...
            <div class="details">
                <div class="recentOrders">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <input type="text" name="level" placeholder="Course level" required value="<?php echo $level ?>">
                        </div> 
                        <div>
                            <input type="text" name="feed" placeholder="Course Feed" required value="<?php echo $feed ?>">
                        </div> 
                        <div>
